...
class Img2Img:
    ...
    @staticmethod
    def img2img(prompt, init_image, strength, num_inference_steps, pipe:StableDiffusionImg2ImgPipeline = Utils.load_SD_pipe(model_name="CompVis/stable-diffusion-v1-4", loader=StableDiffusionImg2ImgPipeline))->Image:
