...
def surprise_me(device, init_image, strength, num_inference_steps):
    seed = 123456

    generator = torch.Generator(device).manual_seed(seed)

    generator_prompt = RandomPromptGenerator()
    prompt = generator_prompt.random_prompt()
    ...
    output_image_path = "selfhost_stablediffusion_api/generator/output_image_surprise.png"
...
init_image_path = "selfhost_stablediffusion_api/generator/init_image.png"
init_image = Image.open(init_image_path)

surprise_me(device_available, init_image, 1, 50)